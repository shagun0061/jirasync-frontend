...
const HoldTicket = ({ filter }) => {
    ...
    const rows = [
        ...
        createData('ELNKWEB-1644', 'Todo', "Kanak", "ELNKWEB", "www.google.com"),
    ];
    ...
    return (
        <TableContainer component={Paper} sx={{ mt: filter == "All" ? 5 : '' }}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                <TableHead>
                    <TableRow>
                        <TableCell align="center" colSpan={12} sx={{ bgcolor: "#FFE0B2", fontFamily: 'Poppins', fontSize: '27px', fontWeight: 900, height: "56px" }}>
                            Hold Ticket
                        </TableCell>
                    </TableRow>
                    <TableRow>
